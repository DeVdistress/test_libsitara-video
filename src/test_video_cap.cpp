...
void threadVideo(const int id, svl::VideoCapture &cap)
{
	int id_ = id;
...
int main(int argc, char *argv[])
{
	...
	std::array<svl::VideoCapture*, 4> cap_mas { nullptr, nullptr, nullptr };
...
#define TEST_VIDEO_COUNT  (4)
	...
	cap_mas[tik] = new svl::VideoCapture(
											...
											false, lst_plane[tik],
											svl::Rectangle<uint32_t>(0,     0,	704, 560),
	...
	cap_mas[tik] = new svl::VideoCapture(
											lst_dev_v4l2.str_[tik], true, true, 8,
											true, lst_plane[tik],
											svl::Rectangle<uint32_t>(1024-704,	768-560,	704,	560),
											svl::Rectangle<uint32_t>(0,			0,			704,	280),
//											svl::Rectangle<uint32_t>(704/2, 0,  704/2,	280),
//											svl::Rectangle<uint32_t>(0,		0,  704,	280),
											true, true, true, my_px_fmt
										);
#endif
